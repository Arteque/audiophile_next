...
const Hero = () => {
  return (
    <section
      className="heroSection relative min-h-[100dvh] pt-[25dvh] bg-dark-100"
      id="heroSection"
    >
      <div className="textContainer sm:container relative z-5 px-[24px]">
        <h1 className="text-center">
          <Subhead className="text-light-100/40">New Product</Subhead>
          <span className="uppercase text-light-200 font-bold text-[36px] tracking-[1.29px] leading-[40px]">
